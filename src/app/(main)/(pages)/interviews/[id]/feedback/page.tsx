            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-1">
                ...
                <div className="text-muted-foreground flex flex-wrap items-center gap-6 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {feedback?.Interview?.createdAt &&
                      formatTimeOnly(feedback?.Interview?.createdAt)}
                  </div>
                  <div className="flex items-center gap-2">
                    <Target className="h-4 w-4" />
                    {feedback?.Interview.interviewType} Interview
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start gap-4 lg:flex-row lg:items-center">
                ...
                <Badge variant="outline" className="px-3 py-1 text-sm">
                  {Number(feedback?.Interview?.duration)} minutes
                </Badge>
              </div>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  {feedback?.improvements?.length === 0 && (
                    <div className="text-muted-foreground text-sm italic">
                      No significant improvements identified in this interview.
                    </div>
                  )}
                  <div className="space-y-2 space-x-2">
